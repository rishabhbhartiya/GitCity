/**
 * Tooltip.jsx
 * High-contrast tooltip on solid surface background.
 */
  ...
  return (
    <div
      style={{
        ...
        pointerEvents: "none",
        zIndex: 9999,
        transform: "translate(16px, -115%)",
      }}
    >
      <div
        style={{
          // Fully opaque — no readability issues
      ...
      >
        ...
        {/* Date — full text, clearly readable */}
        <div
          style={{
            color:     theme.text,
            fontSize:  "0.72rem",
